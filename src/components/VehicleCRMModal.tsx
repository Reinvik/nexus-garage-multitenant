...
import { X, Car, Calendar, History, Wrench, Edit3, Save, MessageSquare, Tag } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-zinc-200">
              <h3 className="font-bold text-zinc-900 mb-4 text-sm uppercase tracking-wider text-zinc-500">Propietario Actual</h3>
              <div className="space-y-3">
                <div>
                  <div className="text-xs text-zinc-400 mb-0.5">Nombre</div>
                  <div className="font-medium text-zinc-900">{ticket.owner_name}</div>
                </div>
                <div>
                  <div className="text-xs text-zinc-400 mb-0.5">Teléfono</div>
                  <div className="font-medium text-zinc-900">{ticket.owner_phone}</div>
                </div>
              </div>
            </div>
