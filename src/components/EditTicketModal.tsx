                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[70vh]">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    type="text"
                                    className="w-full px-3 py-2 rounded-lg border border-zinc-200 focus:border-emerald-500 outline-none transition-all font-mono text-xs uppercase bg-zinc-50/50"
                                    value={vin}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    type="number"
                                    className="w-full px-3 py-2 rounded-lg border border-zinc-200 focus:border-emerald-500 outline-none transition-all font-bold text-xs pr-10 bg-zinc-50/50"
                                    value={mileage}
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            required
                            rows={3}
                            className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all resize-none text-zinc-800 text-sm"
                            value={notes}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2 mb-2">
                            <select
                                className="flex-1 px-3 py-2 rounded-lg border border-zinc-200 text-sm outline-none focus:border-emerald-500 transition-all font-sans"
                                onChange={(e) => {
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            className="w-full px-4 py-2.5 rounded-xl border border-zinc-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all bg-white text-zinc-800"
                            value={mechanicId}
